 ...
 * @author    ladan <email@example.com>
 * @license   GPL-2.0+
 * @link      http://inhabitent.com
 * @copyright 2017 Your Name or Company Name
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget 2
 * Plugin URI:        http://inhabitent.com
 * Description:       A handy business hours for inhabitent
 * Version:           1.0.0
 * Author:            ladan vafi
 * License:           GPL-2.0+
...
class Business_Hours_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'tent-Business_Widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add the stored business hours.'
			)
		);
